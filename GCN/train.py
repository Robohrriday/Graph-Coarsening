...
if __name__ == '__main__':
    ...
    for i in range(args.runs):
        ...
        if i == args.runs - 1: # COMPUTE THE SIZES ONLY ON THE LAST RUN
            ...
            # "data": a,
            "coarsen_features": b,
            "coarsen_train_labels": c,
            "coarsen_train_mask": d,
            "coarsen_val_labels": e,
            "coarsen_val_mask": f,
            "coarsen_edge": g,
            "data_x": h,
            "data_y": i,
            ...
            # Calculate sum
            dictt["total_size"] = sum(dictt.values())
